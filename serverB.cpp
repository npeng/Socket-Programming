...
int main(){
	...
	while (1){
		...
		cout << "The Server B has received " << n << " numbers." << endl;
		...
		cout << "The Server B has successfully finished the reduction "<< fname<<": " << result << endl;
...
void sendtoAWS(int result, char* fname){
	...
	//send signal to identify serverB

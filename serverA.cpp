...
int main(){
	...
	while (1){
		...
		cout << "The Server A has received " << n << " numbers." << endl;
		...
		cout << "The Server A has successfully finished the reduction "<< fname<<": " << result << endl;
...
void sendtoAWS(int result, char* fname){
	...
	//send signal to identify serverA
	int final = htonl(result);
	char servename[2] = "A";
	//cout << servename << endl;
